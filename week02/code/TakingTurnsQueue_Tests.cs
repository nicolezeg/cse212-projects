...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue returns the wrong person. It returned Sue when Bob was expected.
    ...
    // Defect(s) Found: The queue returns the wrong person. It returned Sue instead of Tim.
